...
public final class MainWindow extends JFrame implements ActionListener {
    ...
    public MainWindow() {
        ...
        // "Compound Interest", "Taxes"  and "Yield to Maturity" items
        //
        ...
        menuItem = new JMenuItem("Taxes");
        menuItem.setActionCommand("calculate taxes");
        menuItem.addActionListener(this);
        menu.add(menuItem);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // "calculate taxes" - Calculate federal and state tax
        ...
        try {
            ...
            } else if (action.equals("calculate taxes")) {
                TaxDialog.showDialog(this);
    ...
    private void aboutMyMoney() {
        ...
        info.append("<html>MyMoney Version 1.18<br>");
        info.append("Copyright 2005-2012 Ronald W Hoffman. All rights reserved.<br>");
